...
const IMPORT_DATA = (() => {
  ...
  add("Lucky Block","Anesa01x","High",300000000,"Diamond",1,10);
  ...
  add("Chicleteteirina Bicicleteirina","Mistorage006","High",5000000,"Gold",1,10);
  ...
  add("Chicleteteirina Bicicleteirina","AccMooncat0","High",5000000,"Gold",1,10);
  ...
  add("Ketchuru And Musturu","mixpets0014","High",127500000,"None",1,10);
  ...
  add("Los Spaghettis","lospgxtictac","High",75000000,"None",5,10);
  ...
  add("Hydra Dragon Cannelloni","mixpets0013","Base",350000000,"None",1,10);
  ...
  add("Los Burritos","burrito3697","High",25500000,"None",2,10);
  ...
  add("Garama and Madundung","mixpets0012","Base",50000000,"None",1,10);
  add("Eviledon","mixpets0012","Base",31500000,"None",1,10);
  ...
  add("Mariachi Corazoni","Fozzington","High",15600000,"Gold",1,10);
  ...
  add("Festive 67","KieuHuyLan11","High",60000000,"Lava",1,10);
  add("Chicleteteirina Bicicleteirina","vaztron98","High",46000000,"Diamond",1,10);
  add("La Spooky Combinasion","vaztron98","High",25000000,"Gold",1,10);
  ...
  add("Festive 67","c6715261","High",67500000,"Cursed",6,10);
  ...
  add("Chipso and Queso","mixpets008","Base",25000000,"None",1,10);
  ...
  add("Festive 67","Calocdieukho_09","High",30000000,"Candy",1,10);
  ...
  add("La Spooky Combinasion","electro7eC","High",25000000,"Gold",1,10);
  ...
  add("Esok Sekolah","diesok231","High",45000000,"Diamond",4,10);
  ...
  add("Secret Lucky Block","NinhNhiVan39","High",0,"Diamond",1,10);
  ...
  add("Secret Lucky Block","cosmiccircuit5I","High",0,"None",4,10);
  add("Tictac Sahur","ElectricsHTBYbLa3iF","High",46800000,"Gold",1,10);
  add("Secret Lucky Block","ElectricsHTBYbLa3iF","High",0,"None",3,10);
  ...
  add("Festive 67","CanVyVy355","High",30000000,"Candy",1,10);
  ...
  add("Mariachi Corazoni","cyber7F6F0QYTCNSo8","High",15600000,"Gold",3,10);
  add("Secret Lucky Block","CyberneticWave23uYI0","High",0,"Diamond",1,10);
  add("Secret Lucky Block","CyberneticWave23uYI0","High",0,"None",2,10);
  ...
  add("Festive Lucky Block","festi28321","High",0,"None",3,10);
  ...
  add("W or L","niceworl2","High",120000000,"None",2,10);
  add("W or L","niceworl2","High",180000000,"None",1,10);
  add("Esok Sekolah","esokcnmr","Base",30000000,"None",3,10);
  ...
  add("Secret Lucky Block","1ArunnittillMAXWIN","High",0,"Diamond",1,10);
  ...
  add("Festive 67","OMLT1999","High",60000000,"Lava",1,10);
  ...
  add("Festive 67","cipher15abiCj9iAzt1H","High",63700000,"Radioactive",1,10);
  ...
  add("Festive 67","CosmicNinja60TZte","High",78700000,"Radioactive",1,10);
  ...
  add("Los Combinasionas","radcombi","High",157500000,"Radioactive",2,10);
  ...
  add("Los Puggies","lospuggies434","High",120000000,"None",1,10);
  ...
  add("La Ginger Sekolah","ketchuxgi","Base",75000000,"None",2,10);
  ...
  add("Secret Lucky Block","Blood_V4mpire","High",0,"None",1,10);
  ...
  add("Los Primos","primotralaledon","High",193700000,"Gold",1,10);
  ...
  add("Esok Sekolah","radesokspah2","High",255000000,"Radioactive",1,10);
  add("La Secret Combinasion","secretwew5","High",500000000,"None",1,10);
  add("Ketupat Kepat","buritoxketu","Base",35000000,"None",1,10);
